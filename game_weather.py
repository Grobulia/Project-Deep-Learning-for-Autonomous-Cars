# -*- coding: utf-8 -*-
"""Deep Learning for Autonomous Cars (Group 4)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bG-nAwH3bg9BPCrrnSH89Qppk8RKHh1Y
"""
...
TRACK_TURN_RATE = 0.51 #0.31 and 0.51
...
if night:
    ROAD_COLOR = [0.3, 0.3, 0.5]
elif weather == 'snow':
    ROAD_COLOR = [0.6, 0.6, 0.6]
elif weather == 'rain':
...
class CarRacing(gym.Env, EzPickle):
    ...
    def render(self, mode="human"):
        ...
        if self.weather == "rain":
            ...
            self.render_big_snow(WINDOW_W, WINDOW_H)
    ...
    def render_big_snow(self, W, H):
        ...
        for i in range(0, W, h):
            ...
            for j in range(0, H, h):
                ...
                colors.extend([255, 255, 255, 1] * 12)
                polygons.extend([i + k,
                                 j,
                                 0,
                                 i,
        ...
        for i in range(0, W, h):
            ...
            for j in range(0, H, h):
                ...
                lines.extend([   i,
                                 ...
                                 0])
        vl = pyglet.graphics.vertex_list(
            len(lines) // 3, ("v3f", lines), ("c4f", colors)  # gl.GL_QUADS,
        )
        len(colors)
    ...
    def render_road(self):
        #grass mass
        if night:
            colors = [0.2, 0.6, 0.7, 1.0] * 4
        elif weather == 'rain':
            colors = [0.3, 0.7, 0.5, 1.0] * 4
        elif weather == 'snow':
            colors = [0.6, 1, 0.6, 1.0] * 4
        else:
        ...
        colors2 = [0.4, 0.8, 0.4, 1.0] * 4
        colors2.extend([0.4, 0.9, 0.4, 1.0] * 4 * 20 * 20)

        k = PLAYFIELD / 20.0

        #grass squares
        if night:
            colors.extend([0.2, 0.7, 0.7, 1.0] * 4 * 20 * 20)
        elif weather == 'rain':
            colors.extend([0.4, 0.8, 0.5, 1.0] * 4 * 20 * 20)
        elif weather == 'snow':
            colors.extend([0.6, 0.8, 0.5, 1.0] * 4 * 20 * 20)
        else:
        ...
        for poly, color in self.road_poly:
            ...
            colors2.extend([color[0], color[1], color[2], 1] * len(poly))
            for p in poly:
